...
Route::group(['prefix' => 'user', 'middleware' => 'authToken'], function () {
  ...
  Route::post('toggleStatus', 'User\UserController@toggleStatus');
...
Route::group(['prefix' => 'post', 'middleware' => 'authToken'], function () {
  ...
  Route::post('likes', 'Post\PostController@likes');
...
Route::group(['prefix' => 'battle', 'middleware' => 'authToken'], function () {
  ...
  Route::post('playRandom', 'Battle\BattleController@playRandom');
  Route::post('cancelPlay', 'Battle\BattleController@cancelPlay');
  Route::post('getAll', 'Battle\BattleController@getAll');
  ...
  Route::post('vote', 'Battle\BattleController@vote');
});
